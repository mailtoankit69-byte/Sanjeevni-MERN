...
const Footer = () => {
  ...
  <img className="w-28 mt-1" src={assets.logo} alt="Sanjeevi Logo" />
  <p className="text-gray-600 leading-6 md:max-w-[75%]">
    <strong>Sanjeevi – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li>customersupport@Sanjeevi.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © 2026 Sanjeevi.in — All Rights Reserved.
      </p>
    </div>
  );
};
